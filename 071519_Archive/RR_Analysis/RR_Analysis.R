...
pre_result = result[sapply("Pre", grepl, row.names(result)),]
post1_result = result[sapply("Post1", grepl, row.names(result)),]
post2_result = result[sapply("Post2", grepl, row.names(result)),]
